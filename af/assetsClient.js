...
module.exports = {
    ...
    doTransfer: async(accId, amt) => {
        ...
        console.log("Transfer " + parseInt(amt, 10) + " from " + web3.eth.defaultAccount + " to " + acc);
        try {
            //check balance
            let res = (await erc20Instance.transfer(acc, Number(amt), {from: web3.eth.defaultAccount}));
